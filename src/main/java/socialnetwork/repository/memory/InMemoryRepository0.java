...
public class InMemoryRepository0<ID, E extends Entity<ID>> implements Repository0<ID, E> {
    ...
    public E findOne(ID id) {
        ...
        if(entity == null) throw new RepositoryException("Id-ul nu a fost gasit!");
        return entity;
    }
    ...
    public E delete(ID id) {
        if (id == null)
            throw new IllegalArgumentException("Id mush not be null!");
    ...
    public E update(E entity) {
        ...
        if (entity == null)
            throw new IllegalArgumentException("entity must be not null!");
        validator.validate(entity);
        if (entities.get(entity.getId()) == null) throw new RepositoryException("Id-ul nu a fost gasit!");
